...
/* package ttpc-0.1.0.0 */
#ifndef VERSION_ttpc
#define VERSION_ttpc "0.1.0.0"
#endif /* VERSION_ttpc */
#ifndef MIN_VERSION_ttpc
#define MIN_VERSION_ttpc(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_ttpc */
...
#define CURRENT_COMPONENT_ID "ttpc-0.1.0.0-inplace-ttpc"
